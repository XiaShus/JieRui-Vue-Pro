package com.jierui.boot.ssodemo.client;

import com.jierui.boot.ssodemo.client.dto.CommonResult;
import com.jierui.boot.ssodemo.client.dto.user.UserInfoRespDTO;
import com.jierui.boot.ssodemo.client.dto.user.UserUpdateReqDTO;
