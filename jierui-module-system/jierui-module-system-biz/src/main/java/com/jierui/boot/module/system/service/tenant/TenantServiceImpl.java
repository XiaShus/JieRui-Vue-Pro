package com.jierui.boot.module.system.service.tenant;
...
import com.jierui.boot.framework.tenant.config.TenantProperties;
import com.jierui.boot.framework.tenant.core.context.TenantContextHolder;
import com.jierui.boot.framework.tenant.core.util.TenantUtils;
import com.jierui.boot.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import com.jierui.boot.module.system.convert.tenant.TenantConvert;
...
import com.jierui.boot.module.system.dal.mysql.tenant.TenantMapper;
import com.jierui.boot.module.system.enums.permission.RoleCodeEnum;
import com.jierui.boot.module.system.enums.permission.RoleTypeEnum;
import com.jierui.boot.module.system.service.permission.MenuService;
import com.jierui.boot.module.system.service.permission.PermissionService;
import com.jierui.boot.module.system.service.permission.RoleService;
import com.jierui.boot.module.system.service.tenant.handler.TenantInfoHandler;
import com.jierui.boot.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 jierui.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
