package com.jierui.boot.module.system.controller.admin.permission.vo.role;
...
public class RoleExportReqVO {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "杰瑞")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "jierui")
    private String code;
