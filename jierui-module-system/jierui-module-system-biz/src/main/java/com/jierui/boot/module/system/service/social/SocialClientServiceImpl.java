package com.jierui.boot.module.system.service.social;
...
import com.jierui.boot.framework.common.util.cache.CacheUtils;
import com.jierui.boot.framework.common.util.http.HttpUtils;
import com.jierui.boot.framework.social.core.JieruiAuthRequestFactory;
import com.jierui.boot.module.system.dal.dataobject.social.SocialClientDO;
import com.jierui.boot.module.system.dal.mysql.social.SocialClientMapper;
import com.jierui.boot.module.system.enums.social.SocialTypeEnum;
...
import static com.jierui.boot.framework.common.util.json.JsonUtils.toJsonString;
import static com.jierui.boot.module.system.enums.ErrorCodeConstants.SOCIAL_APP_WEIXIN_MINI_APP_PHONE_CODE_ERROR;
import static com.jierui.boot.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    @Resource // 由于自定义了 JieruiAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private JieruiAuthRequestFactory jieruiAuthRequestFactory;
    ...
    private AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = jieruiAuthRequestFactory.get(SocialTypeEnum.valueOfType(socialType).getSource());
