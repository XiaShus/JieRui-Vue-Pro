package com.jierui.boot.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelBaseVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "张杰瑞")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "jierui")
