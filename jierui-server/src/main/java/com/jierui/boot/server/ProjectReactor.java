package com.jierui.boot;

import cn.hutool.core.io.FileTypeUtil;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import com.jierui.boot.framework.common.util.collection.SetUtils;
...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.jierui.boot";
    private static final String ARTIFACT_ID = "jierui";
    private static final String PACKAGE_NAME = "com.jierui.boot";
    private static final String TITLE = "杰瑞的管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.jierui.boot";
        String artifactIdNew = "jierui";
        String packageNameNew = "com.jierui.boot";
        String titleNew = "杰瑞的管理系统";
