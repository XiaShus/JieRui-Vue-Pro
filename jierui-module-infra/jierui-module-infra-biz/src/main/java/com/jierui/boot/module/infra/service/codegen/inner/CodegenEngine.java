package com.jierui.boot.module.infra.service.codegen.inner;
...
import com.jierui.boot.framework.common.exception.util.ServiceExceptionUtil;
...
import com.jierui.boot.framework.common.util.date.LocalDateTimeUtils;
import com.jierui.boot.framework.common.util.object.ObjectUtils;
...
import com.jierui.boot.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "jierui-module-${table.moduleName}/" + // 顶级模块
                "jierui-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "jierui-module-${table.moduleName}/" + // 顶级模块
                "jierui-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "jierui-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "jierui-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
