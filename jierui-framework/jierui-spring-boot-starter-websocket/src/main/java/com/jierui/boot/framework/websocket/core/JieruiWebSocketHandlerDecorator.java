package com.jierui.boot.framework.websocket.core;
...
public class JieruiWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public JieruiWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
