package com.jierui.boot.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.jierui.boot.framework.common.enums.DocumentEnum;
import com.jierui.boot.framework.mq.core.RedisMQTemplate;
import com.jierui.boot.framework.mq.core.interceptor.RedisMessageInterceptor;
import com.jierui.boot.framework.mq.core.pubsub.AbstractChannelMessageListener;
import com.jierui.boot.framework.mq.core.stream.AbstractStreamMessageListener;
import com.jierui.boot.framework.mq.job.RedisPendingMessageResendJob;
...
public class JieruiMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "jierui.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 jierui.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "jierui.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 jierui.mq.redis.stream.enable=false 禁用多租户
