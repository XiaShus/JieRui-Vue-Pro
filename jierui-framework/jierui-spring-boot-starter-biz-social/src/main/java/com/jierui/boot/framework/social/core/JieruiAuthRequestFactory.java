package com.jierui.boot.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.jierui.boot.framework.social.core.enums.AuthExtendSource;
import com.jierui.boot.framework.social.core.request.AuthWeChatMiniAppRequest;
import com.jierui.boot.framework.social.core.request.AuthWeChatMpRequest;
 ...
 * @date 2021-10-31
 */
public class JieruiAuthRequestFactory extends AuthRequestFactory {
    ...
    public JieruiAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
