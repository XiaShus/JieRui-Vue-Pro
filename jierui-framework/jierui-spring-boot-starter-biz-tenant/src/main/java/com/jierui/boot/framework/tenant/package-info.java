 ...
 *      1）Spring Async：
 *          {@link com.jierui.boot.framework.quartz.config.JieruiAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 JieruiSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.jierui.boot.framework.tenant;
