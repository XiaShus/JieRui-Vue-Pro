...
import com.jierui.boot.framework.tracer.core.aop.BizTraceAspect;
import com.jierui.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "jierui.tracer", value = "enable", matchIfMissing = true)
public class JieruiTracerAutoConfiguration {
