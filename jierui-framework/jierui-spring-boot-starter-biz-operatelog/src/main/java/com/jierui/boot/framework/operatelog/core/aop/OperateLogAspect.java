package com.jierui.boot.framework.operatelog.core.aop;
...
import com.jierui.boot.framework.operatelog.core.enums.OperateTypeEnum;
import com.jierui.boot.framework.operatelog.core.service.OperateLog;
...
import static com.jierui.boot.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.jierui.boot.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.jierui.boot.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.jierui.boot.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.jierui.boot.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.jierui.boot.framework.operatelog.core.annotations.OperateLog operateLog,
